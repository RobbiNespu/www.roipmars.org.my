...
$.getJSON(bcfyOwnHook, function (data) {
  let status = data.status
  if (status) {
    docBcfyAud.innerHTML = '<div class="col-12 mt-2"><audio class="rounded-5 w-75 mx-auto" controls preload="none" src="https://audio.broadcastify.com/41368.mp3" type="audio/mp3" crossorigin="anonymous"></audio></div>\
