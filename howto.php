      ...
      <div class='row'>
        <div class='col-md mb-2 text-center'>
          ...
          <div class='btn-group d-flex mx-auto' role='group'>
            <a class='btn' style='color: #fb4137; border-color: #fb4137' type='button' href='https://github.com/rustdesk/rustdesk/releases/download/1.2.3-1/rustdesk-1.2.3-1-x86_64.exe' target='_blank' rel='nofollow' download>RustDesk &lpar;Windows&rpar; <i class='bi-windows'></i></a>
