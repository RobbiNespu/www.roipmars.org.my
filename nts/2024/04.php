...
<html lang='ms-MY' data-bs-theme='auto'>
  ...
  <head>
    <title>RoIPMARS Network | Notis Naik Taraf Layanan Fail Sijil &amp; eQSL siap</title>
  </head>

  <body>
    <?php include __DIR__.'/../../ntsheader.php' ?>
    <div class='container my-2'>
      <h1 class='text-center'>Naik Taraf Layanan Fail Sijil &amp; eQSL siap</h1>
      ...
      <p class='fs-2 fw-bold text-decoration-underline'>Per: Notis Naik Taraf Layanan Fail Sijil &amp; eQSL siap</p>
      <p>Merujuk kepada perkara diatas, adalah dimaklumkan bahawa fail sijil &amp; eQSL siap akan dialihkan bagi memberi ruang kepada peruntukan sumber pelayan kami untuk jangka panjang.</p>
