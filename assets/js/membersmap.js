...
var A002 = L.marker([3.444039, 101.5528566], { title: 'A002', icon: marsMemIcon }).bindPopup('<img class="img-fluid object-fit-fill rounded-circle mx-auto my-1" src="../media/image/member/002.png" loading="lazy"><p class="text-center fw-bold fs-3 m-0">A002</p><p class="text-center fw-light fs-5 m-0">9W2UZL @ OJ03SK</p><p class="text-center m-0">ZULKIFLI BIN ABU</p>', attrPopup)
...
var A020 = L.marker([2.261893, 102.376587], { title: 'A020', icon: marsMemIcon }).bindPopup('<img class="img-fluid object-fit-fill rounded-circle mx-auto my-1" src="../media/image/member/020.png" loading="lazy"><p class="text-center fw-bold fs-3 m-0">A020</p><p class="text-center fw-light fs-5 m-0">9M2SFF @ OJ12EG</p><p class="text-center m-0">ROZAIMAN SUFFIAN BIN OTHMAN</p>', attrPopup)
