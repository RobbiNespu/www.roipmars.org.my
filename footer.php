          ...
          <div class='col-xl-8 mx-auto my-1 text-xl-start'>
            ...
            <table class='table table-sm table-bordered text-center align-middle my-0'>
              <tbody>
                ...
                <tr><td colspan='2'>Kami juga menerima: <btn class='btn btn-sm' type='button' onClick='donateTngd()' aria-label='Sumbang melalui TNG E-Wallet'><img class='img-fluid bg-light rounded-2 px-1 mb-1' loading='lazy' src='/media/image/brands/tngew/tngew_ht.png' width='50' alt='donate via tng ewallet'> TnG eWallet</btn> &#124; <btn class='btn btn-sm' type='button' onClick='donateToyyib()' aria-label='Sumbang melalui FPX'><img class='img-fluid bg-light rounded-2 p-1 mb-1' loading='lazy' src='/media/image/brands/fpx/fpx.png' width='50' alt='donate via fpx'> Malaysian Local Banks</btn> &#124; <btn class='btn btn-sm' type='button' onClick='donateStripe()' aria-label='Sumbang melalui Kad Debit atau Kredit'><i class='bi-credit-card-fill fs-5 align-middle pb-1'></i> Cards</btn></td></tr>
              </tbody>
            </table>
