...
<head>
  ...
  <meta name='description' content='Malaysian Amateur RoIP Society (MARS) Connection Tutorial'>
  ...
  <meta property='og:description' content='Malaysian Amateur RoIP Society (MARS) Connection Tutorial'>
  ...
  <meta name='twitter:description' content='Malaysian Amateur RoIP Society (MARS) Connection Tutorial'>
    ...
    <div class="container-fluid">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
        <ul class="navbar-nav nav-pills nav-fill justify-content-end">
          ...
          <li class="nav-item"><a class="nav-link active" aria-current="page" href="howto">Tutorial</a></li>
      ...
      <div class="col-md mb-2">
        ...
        <table class="table table-sm text-center table-bordered align-middle">
          ...
          <tbody>
            <tr>
              <th></th>
              <td>Windows 7 SP1 and above<br>32-bit and 64-bit</td>
              <td>Any recent Linux distribution with libstdc++ 6<br>32-bit and 64-bit</td>
              <td>Mac OS X 10.9 and above<br>64-bit Intel CPU</td>
            </tr>
            <tr>
              <th scope="row">CPU</th>
