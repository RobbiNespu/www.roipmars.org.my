      ...
      <div class='row my-2'>
        ...
        <div class='col-lg-4 mx-auto my-1'>
          ...
          <div class='d-grid gap-1 d-md-flex justify-content-md-end mb-2'>
            ...
            <button type='button' class='btn btn-outline-info rounded-5' data-bs-toggle='modal' data-bs-target='.bd-subnewsletter-modal-xl'><i class='bi-envelope-paper'></i> Langgan surat berita
              kami</button>
          </div>
