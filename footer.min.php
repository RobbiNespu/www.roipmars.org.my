        ...
        <div class='row p-3 d-flex align-items-center'>
          <div class='col-md-3 py-2'>
            <div class='d-flex justify-content-evenly'>
              ...
              <a class='text-reset text-decoration-none' href='#' onClick='AudioFeed=window.open("https://www.broadcastify.com//webPlayer/41368", "Malaysian Amateur ROIP Society - RoIPMARS Network Live Audio Feed", "width=780,height=720,scrollbars=no"); return false;' aria-label='RoIPMARS Network Live Audio Feed'><i class='bi-broadcast h1 mx-1' style='color: #336699'></i></a>
