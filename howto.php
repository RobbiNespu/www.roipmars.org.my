...
<head>
  ...
  <meta name='title' content='RoIPMARS Network | Tutorial'>
        ...
        <table class='table table-sm text-center align-middle'>
          <tbody>
            ...
            <tr>
              ...
              <td><a class='btn btn-primary' role='button' href='////dl.roipmars.org.my/files/downloads/android/teamspeak/roipmars-ts-3.0.3.1.apk' download>Versi Tiada Sokongan Google<br>&#40;kurang ciri khas&#41;</a></td>
            </tr>
            <!-- <tr>
              <td>v3.1.9-beta.194</td>
              <td><a class='btn btn-primary' role='button' href='//dl.roipmars.org.my/files/downloads/android/teamspeak/ts-3.1.9_b194.apk' download>Muat Turun</a></td>
            </tr> -->
            <tr>
      ...
      <div class='col-lg-5 position-static p-3'>
        ...
        <table class='table table-sm text-center align-middle'>
          <tbody>
            ...
            <tr><th scope='row'>Android</th><td><a class='btn btn-sm btn-primary' role='button' href='////dl.roipmars.org.my/files/downloads/android/teamspeak/roipmars-ts-3.0.3.1.apk' download>Muat Turun</a></td></tr>
          </tbody>
        </table>
      </div>
      <div class='col-12 position-static p-3'>
