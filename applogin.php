      ...
      <div class='col-12'>
        <form class='my-3 align-middle text-center' id='applogin'>
          ...
          <div class='vstack gap-1 mt-3 text-center'>
            <button class='btn btn-outline-primary btn-lg rounded-pill w-75 mx-auto' type='submit' onClick='ts3hamlogin()'>Log Masuk HAM <img class='img-fluid d-inline-block align-middle' src='//cdn.cdnlogo.com/logos/t/29/teamspeak.svg' width='80'> <img class='img-fluid d-inline-block align-middle' src='media/image/brands/roipmars/brand.png' width='150'></button>
            <button class='btn btn-outline-secondary btn-lg rounded-pill w-75 mx-auto' type='submit' onClick='mumblelogin()'>Log Masuk <img class='img-fluid d-inline-block align-middle' src='//www.mumble.info/css/mumble.svg' width='20'> Mumble <img class='img-fluid d-inline-block align-middle' src='media/image/brands/roipmars/brand.png' width='150'></button>
            <button class='btn btn-outline-primary btn-lg rounded-pill w-75 mx-auto' type='submit' onClick='ts3cblogin()'>Log Masuk CB <img class='img-fluid d-inline-block align-middle' src='//cdn.cdnlogo.com/logos/t/29/teamspeak.svg' width='80'> <img class='img-fluid d-inline-block align-middle' src='media/image/brands/roipmars/brand.png' width='150'></button>
          </div>
        </form>
      </div>
    </div>
