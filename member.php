    ...
    <div class='container'>
      ...
      <div class='collapse navbar-collapse' id='navbarNav'>
        <ul class='nav navbar-nav nav-pills fs-5 text-xl-center text-end d-flex mx-auto'>
          ...
          <li class='nav-item'><a class='nav-link active rounded-3' aria-current='page' href='member'>Keahlian</a></li>
          ...
          <li class='nav-item'><a class='nav-link' href='https://books.zoho.com/portal/roipmarsorgmy/' target='_blank'><i class='bi-person-vcard'></i> Portal Ahli</a></li>
        </ul>
      </div>
    </div>
  </nav>
