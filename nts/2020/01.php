...
<head>
  <title>PPRK | Server Maintainence</title>
  <meta charset='utf-8'>
  ...
  <meta name='title' content='PPRK | Server Maintainence'>
  <meta name='description' content='Persatuan Peminat Radio Komunikasi (RoIP) Server Maintainence'>
  ...
  <meta property='og:title' content='PPRK | Server Maintainence'>
  <meta property='og:description' content='Persatuan Peminat Radio Komunikasi (RoIP) Server Maintainence'>
  <meta property='og:url' content='https://www.roipmars.org.my/nts/2020/01'>
  <meta property='og:image' content='../../media/image/brand_sq.png'>
  <meta property='og:type' content='website'>
  <meta property='og:locale' content='ms-MY'>
  <meta name='twitter:title' content='PPRK | Server Maintainence'>
  <meta name='twitter:description' content='Persatuan Peminat Radio Komunikasi (RoIP) Server Maintainence'>
  <meta name='twitter:url' content='https://www.roipmars.org.my/nts/2020/01'>
...
<body>
  ...
  <div class='container my-2'>
    <p class='fs-1 text-center' style='font-family: "Coda", cursive'>Notice Server Maintainence</p>
    <p class='fs-2 text-end lh-1' style='font-family: "Saira Extra Condensed", sans-serif'>Ruj: NtsMARS2020/01<br>Tarikh Notis: 07 Februari 2020 | 0000 MYT</p>
    <p class='lh-sm'>Pengguna yang dihormati,</p>
    <p class='fs-2 fw-bold text-decoration-underline' style='font-family: "Nanum Gothic Coding", monospace'>Per: Perhatian buat semua pengguna SERVER TS3 MARS Group!</p>
    ...
    <p class='text-center'>Sekiranya anda memerlukan bantuan, sila email kepada: <a href='mailto:member@roipmars.org.my?subject=Inkuiri%20Notis2001'>member@roipmars.org.my</a></p>
