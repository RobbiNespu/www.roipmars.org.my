      ...
      $.ajax({
        ...
        success: function () {
          ...
          $('#success > .alert-success')
            .append('<strong>Your message has been sent. We will be review and reply soon.</strong>');
          $('#success > .alert-success')
            .append('</div>');
          //clear all fields
        ...
        error: function () {
          ...
          $('#success > .alert-danger').html('<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;')
            .append('</button>');
          $('#success > .alert-danger').append($('<strong>').text('Sorry ' + name + ', it seems that mail server is not responding. Please try again later!'));
